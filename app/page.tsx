    ...
    <div className="min-h-screen">
      ...
      <div className="relative h-[600px] bg-gradient-to-r from-purple-600 to-blue-600">
        ...
        <div className="relative container mx-auto px-4 h-full flex flex-col justify-center items-center text-white text-center">
          <h1 className="text-5xl font-bold mb-6">Découvrez Notre Collection de Tissus</h1>
          <p className="text-xl mb-8">Des tissus de qualité pour vos créations uniques</p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Sélection rigoureuse des meilleurs tissus</p>
            </div>
            <div className="text-center">
              <div className="flex justify-center mb-4">
                <TrendingUp className="w-12 h-12 text-purple-600" />
              </div>
              <h3 className="text-xl font-semibold mb-2">Dernières Tendances</h3>
              <p className="text-gray-600">Collections régulièrement mises à jour</p>
            </div>
            <div className="text-center">
              <div className="flex justify-center mb-4">
